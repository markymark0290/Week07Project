...
public class ProjectsApp {
	...
	private Project curProject;  //curProject needs to be uninstantiated in order to return null
	//Step 1 
	//@formatter:off
	...
	private void updateProjectDetails() {
		...
		if(Objects.isNull(curProject)) {
			...
			return; //return statement prevents the catch from running in the user selection method.
		}
		
		String projectName = getStringInput("Enter the project name [" + curProject.getProjectName() + "]");
		BigDecimal estimatedHours = getDecimalInput("Enter the project hours [" + curProject.getEstimatedHours() + "]");
